...
public class ColorblindConfig {
    ...
    private void defineColorblindView() {
        ...
        colorblindView[ValueName.PARKING.ordinal()] =         new DrawAttribute(false, 1, DrawAttribute.cl_pink, -1.0);
        colorblindView[ValueName.UNIVERSITY.ordinal()] =      new DrawAttribute(false, 1, DrawAttribute.cl_darkorange, -1.0);
        //BARRIER
        colorblindView[ValueName.BARRIER.ordinal()] =         new DrawAttribute(false, 0, DrawAttribute.cl_darkorange, -1.0);
        colorblindView[ValueName.HENCE.ordinal()] =           new DrawAttribute(true, 1, DrawAttribute.cl_green, -0.2);
        ...
        //BUILDING
        colorblindView[ValueName.BUILDING.ordinal()] =        new DrawAttribute(false, 0, DrawAttribute.cl_darkorange, -0.5);
        //CRAFT
        ...
        //HIGHWAY
        colorblindView[ValueName.HIGHWAY.ordinal()] =         new DrawAttribute(false, 12, DrawAttribute.cl_white, -1.0);
        colorblindView[ValueName.MOTORWAY.ordinal()] =        new DrawAttribute(false, 12, DrawAttribute.cl_white, -1.0);
        colorblindView[ValueName.MOTORWAY_LINK.ordinal()] =   new DrawAttribute(false, 12, DrawAttribute.cl_white, -1.0);
        colorblindView[ValueName.TRUNK.ordinal()] =           new DrawAttribute(false, 3, DrawAttribute.cl_green, -1.0);
        colorblindView[ValueName.TRUNK_LINK.ordinal()] =      new DrawAttribute(false, 3, DrawAttribute.cl_green, -1.0);
        colorblindView[ValueName.PRIMARY.ordinal()] =         new DrawAttribute(false, 12, DrawAttribute.cl_whiteblue, -1.0);
        colorblindView[ValueName.PRIMARY_LINK.ordinal()] =    new DrawAttribute(false, 12, DrawAttribute.cl_whiteblue, -1.0);
        colorblindView[ValueName.SECONDARY.ordinal()] =       new DrawAttribute(false, 6, DrawAttribute.cl_whiteblue, -1.0);
        colorblindView[ValueName.SECONDARY_LINK.ordinal()] =  new DrawAttribute(false, 6, DrawAttribute.cl_whiteblue, -1.0);
        colorblindView[ValueName.TERTIARY.ordinal()] =        new DrawAttribute(false, 12, DrawAttribute.cl_white, -0.8);
        colorblindView[ValueName.TERTIARY_LINK.ordinal()] =   new DrawAttribute(false, 12, DrawAttribute.cl_white, -0.8);
        colorblindView[ValueName.UNCLASSIFIED.ordinal()] =    new DrawAttribute(false, 6, DrawAttribute.cl_purple, -0.8);
        colorblindView[ValueName.RESIDENTIAL.ordinal()] =     new DrawAttribute(false, 6, DrawAttribute.cl_purple, -1.0);
        colorblindView[ValueName.SERVICE.ordinal()] =         new DrawAttribute(false, 6, DrawAttribute.cl_purple, -1.0);
        colorblindView[ValueName.LIVING_STREET.ordinal()] =   new DrawAttribute(false, 1, DrawAttribute.grey, -0.8);
        colorblindView[ValueName.PEDESTRIAN.ordinal()] =      new DrawAttribute(false, 1, DrawAttribute.cl_pink, -0.5);
        colorblindView[ValueName.TRACK.ordinal()] =           new DrawAttribute(true, 0, DrawAttribute.cl_pink, -0.4);
        colorblindView[ValueName.TRACK.ordinal()] =           new DrawAttribute(false, 0, DrawAttribute.darkblue, -0.4);
        colorblindView[ValueName.ROAD.ordinal()] =            new DrawAttribute(false, 4, DrawAttribute.cl_purple, -0.4);
        colorblindView[ValueName.FOOTWAY.ordinal()] =         new DrawAttribute(true, 1, DrawAttribute.cl_pink, -0.5);
        colorblindView[ValueName.FOOTWAY_AREA.ordinal()] =    new DrawAttribute(false, 1, DrawAttribute.cl_pink, -0.5);
        colorblindView[ValueName.CYCLEWAY.ordinal()] =         new DrawAttribute(true, 1, DrawAttribute.lightblue, -0.1);
        colorblindView[ValueName.BRIDLEWAY.ordinal()] =       new DrawAttribute(true, 0, DrawAttribute.cl_pink, -0.1);
        colorblindView[ValueName.STEPS.ordinal()] =           new DrawAttribute(true, 2, DrawAttribute.cl_pink, -0.1);
        colorblindView[ValueName.PATH.ordinal()] =            new DrawAttribute(true, 0, DrawAttribute.cl_pink, -0.1);
        //HISTORIC
        ...
        colorblindView[ValueName.CONSTRUCTION.ordinal()] =    new DrawAttribute(false, 0, DrawAttribute.cl_pink, -0.4);
        colorblindView[ValueName.GRASS.ordinal()] =           new DrawAttribute(false, 0, DrawAttribute.cl_green, -1.0);
        ...
        colorblindView[ValueName.SCREE.ordinal()] =           new DrawAttribute(false, 0, DrawAttribute.cl_pink, -2.0);
        ...
        colorblindView[ValueName.COASTLINE.ordinal()] =       new DrawAttribute(false, 0, DrawAttribute.cl_orange, -1.0);
        //RAILWAY
        colorblindView[ValueName.RAILWAY.ordinal()] =         new DrawAttribute(true, 1, DrawAttribute.cl_lightblue, -2.0);
        colorblindView[ValueName.LIGHT_RAIL.ordinal()] =      new DrawAttribute(true, 1, DrawAttribute.cl_lightblue, -2.0);
        colorblindView[ValueName.RAIL.ordinal()] =            new DrawAttribute(true, 1, DrawAttribute.cl_lightblue, -2.0);
        colorblindView[ValueName.TRAM.ordinal()] =            new DrawAttribute(true, 1, DrawAttribute.cl_lightblue, -2.0);
        colorblindView[ValueName.SUBWAY.ordinal()] =         new DrawAttribute(true, 1, DrawAttribute.cl_lightblue, -2.0);
        //ROUTE
        colorblindView[ValueName.ROUTE.ordinal()] =           new DrawAttribute(false, 0, DrawAttribute.white, -2.0);
        colorblindView[ValueName.FERRY.ordinal()] =           new DrawAttribute(true, 1, DrawAttribute.cl_lightblue, -2.0);
        //SHOP
